...
<head>
    ...
    <title>ANUTTC - Sélection de Parcelle</title>
    ...
    <style>
        ...
        @media (max-width: 640px) {
            .btn-compact { font-size: 14px; padding: 12px 20px; min-height: 45px; }
            .type-card-compact { padding: 16px; min-height: 120px; }
            .section-title-compact { font-size: 18px; }
            .section-compact { padding: 16px; }
        }

        /* Custom colors for ANUTTC */
        .text-anuttc {
            color: #8B6914;
        }
...
<body class="bg-gray-50">
    ...
    <header class="anuttc-green shadow-lg fixed w-full top-0 z-50 header-scroll" style="background-color: rgba(139, 105, 20, 0.95);">
        <nav class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-20">
                <a href="index.php" class="flex items-center space-x-3">
                    <img src="assets/images/anuttc-logo.jpeg" alt="Logo ANUTTC" class="h-14 w-auto">
                    <span class="text-white text-xl font-bold">ANUTTC</span>
                </a>
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="souscrire" onclick="localStorage.clear()" class="bg-white text-anuttc px-6 py-2 rounded-lg hover:bg-gray-100 transition font-medium">Souscrire</a>
                </div>
            </div>
            ...
            <div class="hidden md:hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1">
                    ...
                    <a onclick="localStorage.clear()" href="souscrire" class="block bg-white text-anuttc px-3 py-2 rounded-md mt-4 text-center">Souscrire</a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <main class="max-w-6xl mx-auto px-4 py-8" x-data="parcelleSimple">
        ...
        <div class="mb-6 sm:mb-10">
            <div class="flex justify-center items-center space-x-1 sm:space-x-4">
                ...
                <div class="flex flex-col items-center">
                    <button @click="window.location.href = 'index.php?page=souscrire'" class="w-6 h-6 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold shadow-lg transition-all duration-300 bg-anuttc text-white cursor-pointer hover:scale-105">1</button>
                    <span class="mt-1 sm:mt-2 text-[10px] sm:text-xs font-medium text-anuttc">Site</span>
                </div>
                <div class="w-4 sm:w-16 h-0.5 sm:h-1 rounded bg-anuttc"></div>

                <!-- Étape 2 : Conditions -->
                <div class="flex flex-col items-center">
                    <button @click="window.location.href = 'index.php?page=conditions'" class="w-6 h-6 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold shadow-lg transition-all duration-300 bg-anuttc text-white cursor-pointer hover:scale-105">2</button>
                    <span class="mt-1 sm:mt-2 text-[10px] sm:text-xs font-medium text-anuttc">Conditions</span>
                </div>
                <div class="w-4 sm:w-16 h-0.5 sm:h-1 rounded bg-anuttc"></div>

                <!-- Étape 3 : Identification -->
                <div class="flex flex-col items-center">
                    <button @click="window.location.href = 'index.php?page=identification'" class="w-6 h-6 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold shadow-lg transition-all duration-300 bg-anuttc text-white cursor-pointer hover:scale-105">3</button>
                    <span class="mt-1 sm:mt-2 text-[10px] sm:text-xs font-medium text-anuttc">Identification</span>
                </div>
                <div class="w-4 sm:w-16 h-0.5 sm:h-1 rounded bg-anuttc"></div>

                <!-- Étape 4 : Parcelle -->
                <div class="flex flex-col items-center">
                    <div class="w-6 h-6 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold shadow-lg transition-all duration-300 bg-anuttc text-white animate-pulse scale-125">4</div>
                    <span class="mt-1 sm:mt-2 text-[10px] sm:text-xs font-medium text-anuttc">Parcelle</span>
                </div>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <span class="mt-1 sm:mt-2 text-[10px] sm:text-xs font-medium text-gray-500">Récapitulatif</span>
                </div>
                <div class="w-4 sm:w-16 h-0.5 sm:h-1 bg-gray-300 rounded"></div>

                <!-- Étape 6 : Paiement -->
                <div class="flex flex-col items-center">
                    <div class="w-6 h-6 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold shadow-lg transition-all duration-300 bg-gray-300 text-gray-600 cursor-not-allowed">6</div>
        ...
        <div class="flex justify-between items-center mt-4 sm:mt-8 max-w-4xl mx-auto px-2 sm:px-0">
            <!-- Bouton Précédent -->
            <button @click="window.location.href = 'index.php?page=identification'" class="px-3 sm:px-6 py-2 sm:py-3 bg-anuttc text-white rounded-lg flex items-center transition-all duration-300 text-xs sm:text-base">
            ...
            <div class="text-center mx-2 sm:mx-4 hidden sm:block">
                <div x-show="!selectedParcelle" class="text-red-600 text-xs sm:text-sm">
            ...
            <!-- Bouton Suivant -->
            <button @click="finalizeSelection()" :class="selectedParcelle ? 'bg-anuttc cursor-pointer' : 'opacity-50 cursor-not-allowed bg-gray-400'" class="px-3 sm:px-6 py-2 sm:py-3 text-white rounded-lg flex items-center transition-all duration-300 text-xs sm:text-base">
                <span>Suivant</span>
        ...
        <div class="mt-8 mb-6 bg-blue-50 border-l-4 border-blue-400 p-4 rounded-lg">
            <div class="flex items-center">
                <i class="fas fa-info-circle text-blue-500 mr-2 text-lg"></i>
                <div>
                    <h3 class="text-lg font-semibold text-blue-800">Choisissez votre parcelle</h3>
                    <p class="text-blue-700">Sélectionnez d'abord le type d'habitation, puis choisissez votre parcelle.</p>
                </div>
            </div>
        </div>

        <!-- SECTION 1: Type de Parcelle -->
        <div x-show="step === 1" class="section-compact">
            <div class="section-title-compact">
                <i class="fas fa-home text-anuttc mr-2"></i>
                Type de parcelle
            </div>
            
            <div x-show="loading" class="text-center py-8">
                <div class="inline-block animate-spin rounded-full h-12 w-12 border-t-4 border-b-4 border-anuttc"></div>
            ...
            <div x-show="!loading" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <template x-for="type in typesParcelles" :key="type.id">
                    <div @click="selectTypeAndNext(type)" :class="{'selected': selectedType?.id === type.id}" class="type-card-compact">
                        <div class="mb-3">
                            <i class="fas fa-home text-2xl text-anuttc mb-2"></i>
                            <h3 class="text-lg font-bold" x-text="type.nom"></h3>
                        </div>
                        
                        <div class="text-xl text-anuttc" x-text="type.description"></div>
                        
                        <div x-show="selectedType?.id === type.id" class="mt-2">
                            <i class="fas fa-check-circle text-anuttc text-xl"></i>
                        </div>
                    </div>
                </template>
            </div>
        ...
        <div x-show="step === 2" class="section-compact">
            <div class="section-title-compact">
                <i class="fas fa-th-large text-anuttc mr-2"></i>
                Parcelles disponibles
            </div>

            <!-- Résumé compact -->
            <div class="border border-gray-300 rounded-lg p-3 mb-6 text-center">
                <span class="font-medium text-anuttc">Type: </span>
                <span class="text-anuttc" x-text="selectedType?.nom"></span>
                <button @click="step = 1" class="ml-3 text-anuttc hover:underline text-sm">
            ...
            <!-- Aucune parcelle -->
            <div x-show="!loading && parcelles.length === 0" class="text-center py-8">
                ...
                <button @click="step = 1" class="btn-compact bg-anuttc text-white">
                    Changer de type
                </button>
            </div>

            <!-- Grid de parcelles avec zones -->
            <div x-show="!loading && parcelles.length > 0">
                <p class="text-center text-lg text-gray-600 mb-6">
                    <span x-text="parcelles.length"></span> parcelle(s) disponible(s)
                </p>

                <!-- Grid responsive -->
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <template x-for="parcelle in parcelles.slice(0, showAllParcelles ? parcelles.length : 6)" :key="parcelle.id">
                        <div @click="selectParcelleAndNext(parcelle)" :class="{'selected': selectedParcelle?.id === parcelle.id}" class="parcelle-grid">
                            <!-- En-tête avec numéro et check -->
                            <div class="flex justify-between items-center mb-3">
                                <h4 class="text-lg font-bold text-gray-800">
                                    <span x-text="parcelle.section + '-' + parcelle.lot + '-' + parcelle.parcelle"></span>
                                </h4>
                                <div x-show="selectedParcelle?.id === parcelle.id" class="text-anuttc">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <div class="font-bold text-anuttc text-lg" x-text="formatNumber(parcelle.prix) + ' FCFA'"></div>
                                </div>
                            </div>
                            
                            <!-- Bouton sélection -->
                            <div class="mt-3">
                                <button @click.stop="selectParcelleAndNext(parcelle)" :class="selectedParcelle?.id === parcelle.id ? 'bg-green-600' : 'bg-anuttc'" class="w-full btn-compact text-white hover:opacity-90">
                                    <span x-text="selectedParcelle?.id === parcelle.id ? 'Sélectionnée' : 'Choisir'"></span>
                                </button>
                            </div>
                        </div>
                    </template>
                ...
                <!-- Bouton "Voir plus" -->
                <div x-show="parcelles.length > 6 && !showAllParcelles" class="text-center mt-6">
                    <button @click="showAllParcelles = true" class="btn-compact bg-gray-600 text-white hover:bg-gray-700">
                        Voir tout (<span x-text="parcelles.length"></span>)
                        <i class="fas fa-chevron-down ml-1"></i>
                    </button>
                </div>

                <div x-show="showAllParcelles && parcelles.length > 6" class="text-center mt-6">
                    <button @click="showAllParcelles = false; window.scrollTo({top: 0, behavior: 'smooth'})" class="btn-compact bg-gray-600 text-white hover:bg-gray-700">
                        Voir moins
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('parcelleSimple', () => {
                return {
                    ...
                    operation: null,
                    typesParcelles: [
                        {id: 1, nom: "Habitation", description: "Parcelle à usage d'habitation"},
                        {id: 2, nom: "Commercial", description: "Parcelle à usage commercial"}
                    ],
                    parcelles: [
                        {id: 1, section: "D", lot: "L03", parcelle: "P005", surface: 1242.03, cout_unitaire: 2500, prix: 3105075, zone_nom: "Zone Résidentielle"},
                        {id: 2, section: "A", lot: "L10", parcelle: "P010", surface: 1590.15, cout_unitaire: 2500, prix: 3975375, zone_nom: "Zone Résidentielle"},
                        {id: 3, section: "E", lot: "L08", parcelle: "P016", surface: 1876.06, cout_unitaire: 2500, prix: 4690150, zone_nom: "Zone Résidentielle"},
                        {id: 4, section: "D", lot: "L06", parcelle: "P006", surface: 1555.82, cout_unitaire: 2500, prix: 3889550, zone_nom: "Zone Résidentielle"},
                        {id: 5, section: "E", lot: "L04", parcelle: "P019", surface: 1720.3, cout_unitaire: 2500, prix: 4300750, zone_nom: "Zone Résidentielle"},
                        {id: 6, section: "E", lot: "L09", parcelle: "P015", surface: 1462.46, cout_unitaire: 2500, prix: 3656150, zone_nom: "Zone Résidentielle"}
                    ],
                    ...
                    init() {
                        console.log('Initialisation sans étape zone');
                    ...
                    async selectTypeAndNext(type) {
                        console.log('Sélection type et chargement parcelles:', type);
